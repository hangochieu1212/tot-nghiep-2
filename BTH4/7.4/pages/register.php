...
<form action="" method="post" class = "form-register" style= margin-left:10px>
  <div>
  ...
  <div>
    ...
    <input type="text" name="class" style=margin-left:36px>
  ...
  <div>
    <label for="tongDiem">Tong</label>
    <input type="text" name="tongDiem" readonly style=margin-left:30px>
  </div>
